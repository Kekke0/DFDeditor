package com.openjfx.dfdeditor.ModelTest;
...
public class TestMain {
    public static void main(String[] args) {
        ...
        corners[2]=new Coordinate(15,25);
        corners[3]=new Coordinate(25,25);
        ...
        data.setName("database");
        elsoszint.addVO(data);
        elsoszint.addVO(random);
